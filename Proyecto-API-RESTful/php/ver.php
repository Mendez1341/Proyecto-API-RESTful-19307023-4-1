...
<html lang="es">
  <head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
			<div class="container">
				<a class="navbar-brand" href="#">LProyecto API RESTful-19307023-4-1</a>
            ...
            <li class="nav-item">
                <a href="../html/Profesores.html" class="nav-link">Volver</a>
            </li>
				  </ul>
				</div>
			</div>
  ...
  <body>
        <div class="container">
        <h2 class="text-center text-white">Profesores Registrados</h2>
        ...
        <?php
            ...
            $contrasenia = 'root';
                    ...
                    try{
                            ...
                            $sql = $gbd->prepare("SELECT * FROM profesores");
                            $sql->execute();
